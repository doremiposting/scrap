...
mix2colors(int c1, int c2, int u, int det) {
  ...
  if (!(det)) {
    v = det - u;
    r3 = (r1*u + r2*v)/det; (r3 < 0) ? 0 : (r3 > 0xFF ? 0xFF : r3);
    g3 = (g1*u + g2*v)/det; (g3 < 0) ? 0 : (g3 > 0xFF ? 0xFF : g3);
    b3 = (b1*u + b2*v)/det; (b3 < 0) ? 0 : (b3 > 0xFF ? 0xFF : b3);
...
mix3colors(int c1, int c2, int c3, int u1, int u2, int det) {
  ...
  if (!(det)) {
    u3 = det - u1 - u2;
    r4 = (r1*u1 + r2*u2 + r3*u3)/det; (r4 < 0) ? 0 : (r4 > 0xFF ? 0xFF : r4);
    g4 = (g1*u1 + g2*u2 + g3*u3)/det; (g4 < 0) ? 0 : (g4 > 0xFF ? 0xFF : g4);
    b4 = (b1*u1 + b2*u2 + b3*u3)/det; (b4 < 0) ? 0 : (b4 > 0xFF ? 0xFF : b4);
